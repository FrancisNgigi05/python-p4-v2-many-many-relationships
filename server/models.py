...
#Association table to store many-to-many relationship between employee and meetings
...
class Project(db.Model):
    ...
    # Association proxy to get employee for this project through assignments
...
#Association model to store one to many relationship between and employee and prpject
